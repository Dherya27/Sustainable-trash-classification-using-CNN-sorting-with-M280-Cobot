...
if __name__ == '__main__':
    ...
    #print(args.labelmap)
    detection_model = load_model('inference_graph_3/saved_model')
    category_index = label_map_util.create_category_index_from_labelmap('labelmap.pbxt', use_display_name=True)
